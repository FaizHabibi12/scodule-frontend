...
function SubmitButton() {
    ...
    return (
        <button
            type="submit"
            disabled={pending}
            className="mt-3 flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[#f2944d] text-base font-semibold text-white transition hover:bg-[#eb8738] disabled:cursor-not-allowed disabled:opacity-70">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="h-12 w-full rounded-xl border border-transparent bg-[#e6e6e8] px-4 pr-11 text-base text-slate-700 outline-none placeholder:text-slate-400 focus:border-[#f08434]"
                                    />
                                    <button
                                        type="button"
